# -*- coding: utf-8 -*-
"""
Created on Fri May 31 09:38:51 2019
...
class BlsbotSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.lifesavered.com/classes/bls-training/']
    ...
    def parse(self, response):
        ...
        self.driver.get('https://www.lifesavered.com/classes/bls-training')
